...
#define BUTTON_PIN         GPIO(GPIO_PORTA, 15)
#define LED_YELLOW_PIN     GPIO(GPIO_PORTB, 30)
#define VPCOM_USART_TX_PIN GPIO(GPIO_PORTA, 22)
#define VPCOM_USART_RX_PIN GPIO(GPIO_PORTA, 23)
...
int main(void)
{
  ...
  gpio_set_pin_function(VPCOM_USART_TX_PIN, PINMUX_PA22C_SERCOM3_PAD0);
  gpio_set_pin_function(VPCOM_USART_RX_PIN, PINMUX_PA23C_SERCOM3_PAD1);
  ...
  /* Periodically send "Hello world" string over UART and blink yellow LED */
  while(1)
  {
